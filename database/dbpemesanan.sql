...
(25, 'Pencuri raden saleh', 'Makanan', 100, 70000, 'corrective.jpg');
...
INSERT INTO `user` (`id_user`, `username`, `password`, `jenis_kelamin`, `status`) VALUES
(7, 'guardian', 'admin', 'Laki-Laki', 'admin'),
(8, 'admin', '1234', 'Laki-Laki', 'user'),
(12, 'erwinjaya', 'erwin11', 'Laki-Laki', 'admin'),
(13, '', '', '', '');
